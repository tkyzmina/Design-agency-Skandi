...
Object(_modules_init_header__WEBPACK_IMPORTED_MODULE_3__["initHeader"])();
...
var initHeader = function initHeader() {
  ...
  if (!header) return;
  var burgerBtn = header.querySelector('.main-nav__toggle');
  var navBlock = header.querySelector('.main-nav__wrapper');
